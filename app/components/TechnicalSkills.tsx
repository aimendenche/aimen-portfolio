  ...
  const technicalSkills: TechnicalSkill[] = [
    {
     ...
     contenuComplet: `
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Introduction à Python</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Ce que j'ai maîtrisé avec Python</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Problèmes résolus grâce à Python</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Qu'est-ce que Flask et Django ?</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Impact de Python dans mon parcours IT</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Vision pour l’avenir avec Python</h4>
...
Je souhaite également approfondir l'automatisation à grande échelle, en explorant des outils comme Ansible ou Airflow, où Python joue un rôle clé. En combinant ces technologies avec ma maîtrise de Python, je suis convaincu que je pourrai relever de nouveaux défis dans le domaine du data engineering et de l’IA.`,
    ...
    },
    {
      ...
      contenuComplet: `
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Introduction</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Pourquoi Linux est mon choix principal</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Mes compétences avec Linux</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Linux dans mes projets quotidiens</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Problèmes résolus grâce à Linux</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Pourquoi Linux continue de m’inspirer</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Vision future avec Linux</h4>
...
contenuComplet: `
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Qu’est-ce qu’Apache NiFi ?</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Pourquoi Apache NiFi est mon choix privilégié</h4>
...
<h4 style="font-size: 1.5rem; font-weight: bold; margin-top: 1.5rem;">Vision future avec NiFi</h4>
